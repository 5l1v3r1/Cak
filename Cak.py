...
print "\n****************************************************************************"
print "Cak"
print "Coded by: Lone Ranger[https://twitter.com/lon3_rang3r]"
print "Date: 31 july 2016"
print "Version: 1.0"
print "Description: security tool to find admin panel of website"
print "****************************************************************************\n"
...
def help():
	print "\n--- help -----------------------------------------------------------------------\n"
	print "syntax:\n"
	print "   Cak.py (site[::ports[::timeout]] | "
	...
	print "\n\nexamples:\n"
	print "   Cak.py www.tk http://guym.co.il/demos/admin_finder/adminpath.txt"
	print "   Cak.py www.tk dictionary.txt \explorer:none \print:success"
	print "   Cak.py http://www.tk directories.txt::/ files.txt extensions.txt"
	print "\n--------------------------------------------------------------------------------\n"
...
#-------------------------------------------------------------------------------------
#--- quickly review that all is well done
#-------------------------------------------------------------------------------------
